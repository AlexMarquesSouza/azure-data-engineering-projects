...
1. Abra [Settings → Pages](https://github.com/AlexMarquesSouza/azure-data-engineering-projects/settings/pages).
...
```text
https://alexmarquessouza.github.io/azure-data-engineering-projects/
```
